define([
    ...
    var s = {
        ...
        buttonMsg : {
            button_1 : "6_dd_filter_button_1_msg",
            button_1_list : "6_dd_filter_button_1_list_msg",
            button_2 : "6_dd_filter_button_2_msg",
            button_2_list : "6_dd_filter_button_2_list_msg",
            button_3 : "6_dd_filter_button_3_msg",
            button_3_list : "6_dd_filter_button_3_list_msg"
        },
    ...
    function IndicatorProcesses6(o) {
    ...
    IndicatorProcesses6.prototype._initVariables = function () {

        s.filterDivMsg1 = this.filterDivMsg1;
    };

    IndicatorProcesses6.prototype._renderTemplate = function (item_to_show_prefix, item_to_show, codelistMaxIndex) {

        this._renderGeoSelection(item_to_show_prefix, item_to_show, codelistMaxIndex);

    }

    IndicatorProcesses6.prototype.disable_element = function () {

        $('[data-selector = "'+s.filter_items.item_12+'"]').attr('disabled','disabled');
    }

    IndicatorProcesses6.prototype._renderGeoSelection = function (item_to_show_prefix, item_to_show, codelistMaxIndex) {
    ...
    IndicatorProcesses6.prototype._filterSelectionValidation = function (values, params, button_type) {
    ...
    IndicatorProcesses6.prototype._geoItemSelectionValidation = function (values) {
    ...
    IndicatorProcesses6.prototype.onClickButton1 = function (values, dashboardConfig, params) {
    ...
    IndicatorProcesses6.prototype.onClickButton2 = function (values, dashboardConfig, params) {
    ...
    IndicatorProcesses6.prototype.onClickButton3 = function (values, dashboardConfig, params) {
        ...
        IndicatorProcesses6.prototype.bindEventListener = function () {
        var self = this;
        var anchor;
    ...
    IndicatorProcesses6.prototype.tableDataCreation = function (param, columnsMap, data, filterValues) {
    ...
    IndicatorProcesses6.prototype.onSelectFilter = function (hostParam, filterResponse, commonParam) {
    ...
    IndicatorProcesses6.prototype.updateVariables = function (obj) {
    ...
    IndicatorProcesses6.prototype._table_element_configuration_update = function (dashboardConfig, values, params) {
    ...
    IndicatorProcesses6.prototype._download_element_table_element_configuration_update = function (dashboardConfig, values, params) {
    ...
    IndicatorProcesses6.prototype._download_element_raw_data_configuration_update = function (dashboardConfig, values, params) {
     ...
     */
    IndicatorProcesses6.prototype.on = function (channel, fn, context) {
    ...
    IndicatorProcesses6.prototype._trigger = function (channel) {
