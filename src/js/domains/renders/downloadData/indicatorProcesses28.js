define([
    ...
    function IndicatorProcesses9(o) {
    ...
    IndicatorProcesses9.prototype._initVariables = function () {

        s.filterDivMsg1 = this.filterDivMsg1;
    };

    IndicatorProcesses9.prototype._renderTemplate = function (item_to_show_prefix, item_to_show, codelistMaxIndex) {

        this._renderGeoSelection(item_to_show_prefix, item_to_show, codelistMaxIndex);

    }

    IndicatorProcesses9.prototype.disable_element = function () {

        $('[data-selector = "'+s.filter_items.item_12+'"]').attr('disabled','disabled');
    }

    IndicatorProcesses9.prototype._renderGeoSelection = function (item_to_show_prefix, item_to_show, codelistMaxIndex) {
    ...
    IndicatorProcesses9.prototype._filterSelectionValidation = function (values, params, button_type) {
    ...
    IndicatorProcesses9.prototype._geoItemSelectionValidation = function (values) {
    ...
    IndicatorProcesses9.prototype.onClickButton1 = function (values, dashboardConfig, params) {
    ...
    IndicatorProcesses9.prototype.onClickButton2 = function (values, dashboardConfig, params) {
    ...
    IndicatorProcesses9.prototype.onClickButton3 = function (values, dashboardConfig, params) {
        ...
        IndicatorProcesses9.prototype.bindEventListener = function () {
        var self = this;
        var anchor;
    ...
    IndicatorProcesses9.prototype.tableDataCreation = function (param, columnsMap, data, filterValues) {
    ...
    IndicatorProcesses9.prototype.onSelectFilter = function (hostParam, filterResponse, commonParam) {
    ...
    IndicatorProcesses9.prototype.updateVariables = function (obj) {
    ...
    IndicatorProcesses9.prototype._table_element_configuration_update = function (dashboardConfig, values, params) {
    ...
    IndicatorProcesses9.prototype._download_element_table_element_configuration_update = function (dashboardConfig, values, params) {
    ...
    IndicatorProcesses9.prototype._download_element_raw_data_configuration_update = function (dashboardConfig, values, params) {
     ...
     */
    IndicatorProcesses9.prototype.on = function (channel, fn, context) {
    ...
    IndicatorProcesses9.prototype._trigger = function (channel) {
