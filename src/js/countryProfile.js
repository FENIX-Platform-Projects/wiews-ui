define([
    ...
    "underscore",
    "../config/config",
    "../config/countryProfile/config",
    "../html/countryProfile/template.hbs",
    "fenix-ui-dashboard",
    "fenix-ui-filter",
    ...
    "jstree"
        ...
        CountryProfile.prototype._validateConfig = function () {
        ...
        CountryProfile.prototype._attach = function () {

            $(s.EL).html(template(labels[Clang]));
        };

        CountryProfile.prototype._initVariables = function () {
        ...
        CountryProfile.prototype._importThirdPartyCss = function () {
